package com.ar.laboratory.collabchat.example.infrastructure.web.controller;
...
import com.ar.laboratory.collabchat.example.application.inbound.command.CreateExampleCommand;
import com.ar.laboratory.collabchat.example.application.inbound.command.FindExampleByDniCommand;
import com.ar.laboratory.collabchat.example.application.inbound.command.ListExamplesCommand;
import com.ar.laboratory.collabchat.example.application.query.ExampleFilter;
import com.ar.laboratory.collabchat.example.domain.exception.ExampleAlreadyExistsException;
...
import com.ar.laboratory.collabchat.example.infrastructure.inbound.web.controller.ExampleController;
import com.ar.laboratory.collabchat.example.infrastructure.inbound.web.dto.CreateExampleRequest;
import com.ar.laboratory.collabchat.example.infrastructure.inbound.web.dto.ExampleResponse;
import com.ar.laboratory.collabchat.example.infrastructure.inbound.web.mapper.ExampleDtoMapper;
import com.ar.laboratory.collabchat.shared.infrastructure.config.GlobalExceptionHandler;
