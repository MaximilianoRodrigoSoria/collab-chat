package com.ar.laboratory.collabchat.shared.infrastructure.metrics;
...
public class UseCaseMetricsAspect {
     ...
     */
    @Around(
            "execution(* com.ar.laboratory.collabchat..application.inbound.command..*(..))"
                    + " && !within(com.ar.laboratory.collabchat..infrastructure..*)")
